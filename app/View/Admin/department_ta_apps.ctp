                ...
                <tr <?php if(!$app['DepartmentTaApp']['selected']){echo 'class="tr-hide"';}?> >
                    ...
                    <td align='right'>
                        <?php 
                            ...
                            if($app['DepartmentTaApp']['selected']) {
                                echo $this->Html->link('Remove TA', array('controller'=>'admin', 'action'=>'remove_department_ta', $app['DepartmentTaApp']['id']), array('class'=>'btn btn-xs btn-danger'), 
                                    'Are you sure to !!REMOVE!! '.$app['User']['name'].' as a TA?');
                            } else {
                                echo $this->Html->link('Select TA', array('controller'=>'admin', 'action'=>'add_department_ta', $app['DepartmentTaApp']['id']), array('class'=>'btn btn-xs btn-default'),
